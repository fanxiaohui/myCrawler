...
static void main_process_cb(struct bufferevent *bev, void *ctx)
{
...
static void main_event_cb(struct bufferevent *bev, short events, void *ctx)
{
...
static void timeout_cb(int fd, short _event, void *arg)
{
...
int main(int argc, char **argv)
{
    ...
    for (it_stat = stat_map.begin(); it_stat != stat_map.end(); it_stat++)
    {
        timer_context_t* timer_context = timer_context_new(it_stat->first.c_str(), thread_context_list, Config::getInstance()->DnsUpdateInterval(),dnsbase);
